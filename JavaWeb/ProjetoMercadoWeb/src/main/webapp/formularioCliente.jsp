...
ConexaoDAO db = new ConexaoDAO();
  ...
  if (id > 0){
     ...
     if (retorno.next()){
        ...
        situacao = retorno.getString("ativo");
      ...
      <div>
          <div class="form-check form-check-inline">
            <label class="form-control">
              <input type="radio" name="situacao" value="1" <% if (ativo){ out.write("checked=''");} %>> Ativo
            </label>
          </div>

          <div class="form-check form-check-inline">
            <label class="form-control">
              <input type="radio" name="situacao" value="0"<% if (!ativo){ out.write("checked=''");} %>> Inativo
            </label>
          </div>
      </div>
